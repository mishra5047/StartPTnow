...
//        txtTotalTime.setText(common.get_service_total_times_string());
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position == 0){
            ...
            bulletTextModelArrayList.add(new BulletTextModel("1.",("Patient Application"), "https://startptnow.com/wp-content/uploads/2019/01/REGULAR-PATIENT-INFORMATION-medical-updated.pdf"));
            bulletTextModelArrayList.add(new BulletTextModel("2.",getResources().getString(R.string.photo_id), ""));
            bulletTextModelArrayList.add(new BulletTextModel("3.",getResources().getString(R.string.insurance_card_if_applicable), ""));
            bulletTextModelArrayList.add(new BulletTextModel("4.","List Of Current Medication", ""));
            bulletTextModelArrayList.add(new BulletTextModel("5.",getResources().getString(R.string.prescription), ""));
            ...
            rv_point.setVisibility(View.VISIBLE);
            ArrayList<BulletTextModel> bulletTextModelArrayList = new ArrayList<>();
            bulletTextModelArrayList.add(new BulletTextModel("1.",getResources().getString(R.string.ptsmc_pip), "https://startptnow.com/wp-content/uploads/2019/01/PIP-LITIGATION-PATIENT-INFORMATION-medical-updated.pdf"));
            bulletTextModelArrayList.add(new BulletTextModel("2.",getResources().getString(R.string.photo_id), ""));
            bulletTextModelArrayList.add(new BulletTextModel("3.","List Of Current Medication", ""));
            bulletTextModelArrayList.add(new BulletTextModel("4.",getResources().getString(R.string.physican_referral), ""));
            bulletTextModelArrayList.add(new BulletTextModel("5.",getResources().getString(R.string.attorney_info), ""));
            rv_point.setLayoutManager(new LinearLayoutManager(this));
            BulletTextAdapter bulletTextAdapter = new BulletTextAdapter(this, bulletTextModelArrayList);
            rv_point.setAdapter(bulletTextAdapter);
            txt.setMaxLines(0);
            ...
            rv_point.setVisibility(View.VISIBLE);
            ArrayList<BulletTextModel> bulletTextModelArrayList = new ArrayList<>();
            bulletTextModelArrayList.add(new BulletTextModel("1.",getResources().getString(R.string.ptsmc_wc_apply), "https://startptnow.com/wp-content/uploads/2019/01/WORKERS-COMPENSATION-PATIENT-INFORMATION-medical-updated.pdf"));
            bulletTextModelArrayList.add(new BulletTextModel("2.",getResources().getString(R.string.photo_id), ""));
            bulletTextModelArrayList.add(new BulletTextModel("3.","List Of Current Medications", ""));
            bulletTextModelArrayList.add(new BulletTextModel("4.",getResources().getString(R.string.physican_referral), ""));
            bulletTextModelArrayList.add(new BulletTextModel("5.",getResources().getString(R.string.adjuster_info), ""));
            rv_point.setLayoutManager(new LinearLayoutManager(this));
            BulletTextAdapter bulletTextAdapter = new BulletTextAdapter(this, bulletTextModelArrayList);
            rv_point.setAdapter(bulletTextAdapter);
            txt.setMaxLines(0);
            ...
            rv_point.setVisibility(View.VISIBLE);
            ArrayList<BulletTextModel> bulletTextModelArrayList = new ArrayList<>();
            bulletTextModelArrayList.add(new BulletTextModel("1.","Patient Application", "https://startptnow.com/wp-content/uploads/2019/01/SELF-PAY-PATIENT-INFORMATION-medical-updated.pdf"));
            bulletTextModelArrayList.add(new BulletTextModel("2.",getResources().getString(R.string.photo_id), ""));
            bulletTextModelArrayList.add(new BulletTextModel("3.","List Of Current Medications", ""));
            bulletTextModelArrayList.add(new BulletTextModel("4.","Prescription / Physican Referral (If Applicable)", ""));
            rv_point.setLayoutManager(new LinearLayoutManager(this));
            BulletTextAdapter bulletTextAdapter = new BulletTextAdapter(this, bulletTextModelArrayList);
            rv_point.setAdapter(bulletTextAdapter);
            txt.setMaxLines(0);
